package cn.liushiyao.reptile.zhihu;
...
//        htmlParserToolTest ();
    ...
    public static void htmlParserToolTest(){

        LinkFilter  linkFilter = new LinkFilter ( ) {
            @Override
            public boolean accept ( String url ) {
                if(url.startsWith ( "http://www.qq.com" )){
                    return true;
                }else{
                    return false;
                }
        ...
        Set<String > set = HtmlParserTool.extracLinks ( "http://www.qq.com",linkFilter );
